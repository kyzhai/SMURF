...
$(SMURF): $(OBJ)
	ocamlc -g -o test util.cmo parser.cmo scanner.cmo ast.cmo test.cmo
	ocamlc -g -o smurf util.cmo parser.cmo scanner.cmo ast.cmo sast.cmo semanalyze.cmo smurf.cmo 
...
clean:
	rm -f *.cmi *.cmo parser.ml scanner.ml *.output parser.mli test smurf toplevel *.cma
