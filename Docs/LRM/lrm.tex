...
manual.  {\it r}$*$ means the pattern {\it r} may appear zero or more time,
{\it r}$+$ means the {\it r} may appear one or more times, {\it r}$?$
means {\it r} may appear zero or once. {\it r1}$|${\it r2} denotes an option
between two patterns, {\it r1 r2} denotes {\it r1} followed by
{\it r2}. 
